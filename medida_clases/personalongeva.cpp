...
Persona Personalongeva::getPersonaMasLongevaValor(const std::vector<Persona>& personas){
    if(personas.empty()) throw std::runtime_error("No hay personas disponibles");
